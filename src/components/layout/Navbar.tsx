      ...
      <header className="sticky top-0 z-50 w-full border-b border-gray-200/60 dark:border-white/[0.06] bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Social Links */}
            <a
              href="https://x.com/geniusinvestory"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:flex w-8 h-8 items-center justify-center rounded-lg text-gray-500 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
              title="X (Twitter)"
            >
            ...
            <a
              href="https://github.com/thistory/investory"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:flex w-8 h-8 items-center justify-center rounded-lg text-gray-500 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
              title="GitHub"
